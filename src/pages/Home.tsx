        ...
        <div className="container" style={{ paddingBottom: '4rem', maxWidth: '1000px' }}>
            ...
            <div className="flex flex-col gap-4">
                <div className="card" style={{ overflowX: 'auto' }}>
                    <div className="card-header bg-red-50 text-red-700">
                        <h3>▲ 상승 모멘텀 순위</h3>
                    </div>
                    <div className="table-container">
                        <table className="data-table">
                            ...
                            <tbody>
                                {data.upItems && data.upItems.map((item, i) => (
                                    <tr key={`up-${i}`}>
                                        ...
                                        <td className="td-data" data-label="전일대비">{item.diffPrev}</td>
                ...
                <div className="card" style={{ overflowX: 'auto', marginTop: '2rem' }}>
                    <div className="card-header bg-blue-50 text-blue-700">
                        <h3>▼ 하락 모멘텀 순위</h3>
                    </div>
                    <div className="table-container">
                        <table className="data-table">
                            ...
                            <tbody>
                                {data.downItems && data.downItems.map((item, i) => (
                                    <tr key={`down-${i}`}>
                                        <td className="td-rank">
                                            <div className={`rank-badge ${item.rank <= 3 ? 'top-rank' : ''}`}>
                                                {item.rank}
